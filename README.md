...
The project code is implemented on a Python Notebook which can be found at [project/ML model](ML Model) . The notebook includes data analysis, exploration and model builing for the project. 
